...
// configuration step. It creates a namespace called `test_of_ftxui`. You can modify
...
int main(int argc, const char **argv)
{
 ...
 Options:
    ...
    std::map<std::string, docopt::value> args = docopt::docopt(USAGE,
      ...
      fmt::format("{} {}",
        test_of_ftxui::cmake::project_name,
        test_of_ftxui::cmake::project_version));// version string, acquired
